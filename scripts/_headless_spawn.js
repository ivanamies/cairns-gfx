// Headless byte-gate spawn script.
//
// Loads 9 GLBs explicitly (the JS owns the catalog), then spawns one
// entity per loaded prefab in a 3x3 grid at z=-3.
//
...
// Load each path. cairns.prefab.load is single-path; the loop
...
// Spawn one entity per loaded prefab in a 3x3 grid.
