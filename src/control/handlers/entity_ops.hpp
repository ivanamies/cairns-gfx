...
//
// Per-entity ops -- the Unity-shaped control surface over a scene's
...
// active scene is only a convenience default), matching the N-scene workflow.
// TRS rides as plain float arrays through engine_headless so control needs
// no glm dependency.
