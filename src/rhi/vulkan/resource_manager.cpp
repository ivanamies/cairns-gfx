...
bool ResourceManager::InitDevice(Device& dev, Allocator& alloc) {
    ...
    // teardown; RM only borrows the handle values (no double-destroy).
    impl_->validation_enabled = dev.impl_->validation_enabled;
    impl_->instance = dev.impl_->instance;
    impl_->debug_messenger = dev.impl_->debug_messenger;
    ...
    impl_->compute_queue = dev.impl_->compute_queue;
    impl_->present_queue = dev.impl_->present_queue;
