...
#define CAIRNS_PRINT_ERR(...) __android_log_print(ANDROID_LOG_ERROR, "cairns", __VA_ARGS__)
#elif CAIRNS_APPLE && TARGET_OS_IPHONE
#include <SDL3/SDL_log.h>
#define CAIRNS_PRINT(...) SDL_Log(__VA_ARGS__)
#define CAIRNS_PRINT_ERR(...) SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, __VA_ARGS__)
#else
#include <cstdio>
...
#define CAIRNS_PRINT_ERR(...) std::fprintf(stderr, __VA_ARGS__)
#endif
